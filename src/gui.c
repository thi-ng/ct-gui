...
extern void ctgui_draw_sprite(uint16_t x, uint16_t y, uint8_t id,
			      CTGUI_SpriteSheet *sprite);
extern void ctgui_draw_raw(uint16_t x, uint16_t y, uint16_t width,
...
CTGUI_Element *ctgui_element_init(uint8_t id, char *label, uint16_t x,
